...
from data.custom_transformations import mask_image, crop_around_mask_bbox, normalize_cxr, mask_convention_setter, k_means_image
from util.metadata_utils import get_paths_and_nodules
import matplotlib.pyplot as plt


class CustomTrainSemanticDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            #new:
            cropped_masked_image, mask_array = k_means_image(cropped_image, new_mask_bbox, clusters=self.clusters)

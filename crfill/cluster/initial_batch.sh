...
COMMAND="python -u train.py --name $NAME --num_workers 20 --checkpoints_dir $LOGGING_DIR/$NAME --gpu_ids 0,1 --beta_l1 1.5 --lambda_feat 0.5 --batchSize 48 $STANDARD_PARAMS"
...
COMMAND="python -u train.py --name $NAME --num_workers 20 --checkpoints_dir $LOGGING_DIR/$NAME --gpu_ids 2,3 --beta_l1 1.5 --batchSize 48 $STANDARD_PARAMS"

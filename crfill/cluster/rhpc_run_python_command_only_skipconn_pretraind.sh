...
DISCRIMINATOR_LOC="$SCRATCH/chalnode_checkpoints/ssim551_lisa/ssim551_lisa/latest_net_D.pth"

GENERATOR_LOC="$SCRATCH/chalnode_checkpoints/ssim551_lisa/ssim551_lisa/latest_net_G.pth"


STANDARD_PARAMS="--seed 0 --batchSize 30 --gan_mode hinge --niter_decay 15 --load_base_d $DISCRIMINATOR_LOC --load_base_g $GENERATOR_LOC --ssim_loss --include_chexpert --include_mimic --node21_resample_count 10 --dataset_mode_train custom_train_all --dataset_mode custom_train --train_image_dir /data --netG twostagend --netD deepfill --preprocess_mode none --validation_freq 20000 --niter 43 --display_freq 100 --model arrangeskipconn"

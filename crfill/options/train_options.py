...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lambda_rcnn', type=float, default=1.0, help='weight for the rcnn loss')
        parser.add_argument('--k_means_clusters', type=int, default=3, help='how many cluster centers')
        ...
        parser.add_argument('--vgg_loss', action='store_true', help='if specified, do *not* use VGG feature matching loss')

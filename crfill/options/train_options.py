...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--no_TTUR", action="store_true", help="Don't use TTUR training scheme"
        )
        ...
        parser.add_argument(
            "--lambda_rcnn", type=float, default=1.0, help="weight for the rcnn loss"
        )
        ...
        parser.add_argument(
            ...
            type=float,
            default=1.0,
            help="weight for l1 loss, this is actually beta in the paper",
        )
        parser.add_argument(
            "--no_l1_loss",
            action="store_true",
            help="if specified, do *not* use l1 loss",
        )
        ...
        parser.add_argument(
            "--masked_loss",
            action="store_true",
            help="if specified, apply mask on VGG feature matching loss",
        )
        parser.add_argument(
